...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/brukerapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11228&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/brukerapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `brukerapi` can be installed with:

```
conda install brukerapi
```

It is possible to list all of the versions of `brukerapi` available on your platform with:
